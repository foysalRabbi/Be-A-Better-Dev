...
public class QuestionSection1 extends AppCompatActivity {

    private List<PhysicsBasic> quesList1;
    public int score = 0;
    private int ctr1 = 1;
    private PhysicsBasic currentQ1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_section1);

        Bundle bundle2 = getIntent().getExtras();
        quizName = bundle2.getString("QuizType");

        toolbar = findViewById(R.id.questsec1_toolbar);
        ...
        if (b != null) {
            tableName = (String) b.get("MOMENTUM");
    ...
    public void showResult() {
        Intent intent = new Intent(QuestionSection1.this, ResultActivity.class);
        Bundle b = new Bundle();
        b.putInt("scorePhysics", score);//Your score
