...
public class LeaderBoardAdapterPhyI extends RecyclerView.Adapter<LeaderBoardAdapterPhyI.ViewHolderUsers> {

    private List<UserModel> mUsers;
    private Context mContext;
    ArrayList<Map.Entry<String, Integer>> list;

    public LeaderBoardAdapterPhyI(Context context, List<UserModel> fireUsers) {
    ...
    public void sortingScore() {
        ...
        for(int i=0;i<mUsers.size();i++) {
            ...
            getNameWithScore.put(fireUser.getDisplayName(), fireUser.getPhysicMarksI());
            //}
        }
