...
public class LeaderBoardAdapterPhyE extends RecyclerView.Adapter<LeaderBoardAdapterPhyE.ViewHolderUsers> {
    private List<UserModel> mUsers;
    private Context mContext;
    ArrayList<Map.Entry<String, Integer>> list;

    public LeaderBoardAdapterPhyE(Context context, List<UserModel> fireUsers) {
        mUsers = fireUsers;
        mContext = context;
    ...
    public void sortingScore() {
        ...
        for(int i=0;i<mUsers.size();i++) {
            ...
            getNameWithScore.put(fireUser.getDisplayName(), fireUser.getPhysicMarksE());
            //}
        }
