...
public class LeaderBoardAdapterCheB extends RecyclerView.Adapter<LeaderBoardAdapterCheB.ViewHolderUsers> {

    private List<UserModel> mUsers;
    private Context mContext;
    ArrayList<Map.Entry<String, Integer>> list;

    public LeaderBoardAdapterCheB(Context context, List<UserModel> fireUsers) {
        mUsers = fireUsers;
        mContext = context;
    }
    @Override
    ...
    public void sortingScore() {
        ...
        for(int i=0;i<mUsers.size();i++) {
            ...
            getNameWithScore.put(fireUser.getDisplayName(), fireUser.getChemistryMarksB());
            //}
        }
