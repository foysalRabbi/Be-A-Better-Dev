...
public class LeaderBoardAdapterCheE extends RecyclerView.Adapter<LeaderBoardAdapterCheE.ViewHolderUsers> {

    private List<UserModel> mUsers;
    private Context mContext;
    ArrayList<Map.Entry<String, Integer>> list;

    public LeaderBoardAdapterCheE(Context context, List<UserModel> fireUsers) {
        mUsers = fireUsers;
        mContext = context;
    }
    @Override
    ...
    public void sortingScore() {
        ...
        for(int i=0;i<mUsers.size();i++) {
            ...
            getNameWithScore.put(fireUser.getDisplayName(), fireUser.getChemistryMarksE());
            //}
        }
