...
public class LeaderBoardAdapterEngI extends RecyclerView.Adapter<LeaderBoardAdapterEngI.ViewHolderUsers> {

    private List<UserModel> mUsers;
    private Context mContext;
    ArrayList<Map.Entry<String, Integer>> list;

    public LeaderBoardAdapterEngI(Context context, List<UserModel> fireUsers) {
        mUsers = fireUsers;
        mContext = context;
    }
    @Override
    ...
    public void sortingScore() {
        ...
        for(int i=0;i<mUsers.size();i++) {
            ...
            getNameWithScore.put(fireUser.getDisplayName(), fireUser.getEnglishMarksI());
            //}
        }
